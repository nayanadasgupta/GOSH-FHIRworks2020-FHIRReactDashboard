...
An interactive and realtime web dashboard, aimed at hospital administrators, which pulls data from FHIR records and produces analytical visualisations using React, Recharts and Material-UI. Unit Tests are written using Jest.
